...
$revenue     = $pdo->query("SELECT SUM(total_bill) FROM reservations")->fetchColumn() ?? 0;
$avg_days    = $pdo->query("SELECT AVG(num_days) FROM reservations")->fetchColumn() ?? 0;
$today_count = $pdo->query("SELECT COUNT(*) FROM reservations WHERE DATE(date_reserved) = CURDATE()")->fetchColumn();
...
<div class="admin-content">
    ...
    <div class="stats-grid">
        ...
        <div class="stat-card">
            <div class="stat-number"><?= round($avg_days, 1) ?></div>
    ...
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:16px; flex-wrap:wrap; gap:10px;">
        ...
        <a href="add.php" class="btn btn-primary btn-sm">+ Add Reservation</a>
    </div>
